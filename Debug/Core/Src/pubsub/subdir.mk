...
CC_SRCS += \
../Core/Src/pubsub/topic.cc 

CC_DEPS += \
./Core/Src/pubsub/topic.d 

OBJS += \
./Core/Src/pubsub/topic.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/pubsub/%.o Core/Src/pubsub/%.su Core/Src/pubsub/%.cyclo: ../Core/Src/pubsub/%.cc Core/Src/pubsub/subdir.mk
...
clean: clean-Core-2f-Src-2f-pubsub

clean-Core-2f-Src-2f-pubsub:
	-$(RM) ./Core/Src/pubsub/topic.cyclo ./Core/Src/pubsub/topic.d ./Core/Src/pubsub/topic.o ./Core/Src/pubsub/topic.su

.PHONY: clean-Core-2f-Src-2f-pubsub
