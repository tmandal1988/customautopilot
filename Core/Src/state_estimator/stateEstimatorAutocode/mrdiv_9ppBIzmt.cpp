...
void mrdiv_9ppBIzmt(const real32_T A[45], const real32_T B[9], real32_T Y[45])
{
  int32_T r1;
  int32_T r2;
  int32_T r3;
  ...
  for (rtemp = 0; rtemp < 15; rtemp++) {
    ...
    Y_tmp_0 = 15 * r2 + rtemp;
    Y[Y_tmp_0] = A[rtemp + 15] - b_A[r1 + 3] * Y[Y_tmp];
    Y_tmp_1 = 15 * r3 + rtemp;
    Y[Y_tmp_1] = A[rtemp + 30] - b_A[r1 + 6] * Y[Y_tmp];
    Y[Y_tmp_0] /= b_A[r2 + 3];
