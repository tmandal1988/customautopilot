...
class fcsModel final
{
 ...
 public:
  ...
  struct DW_pidWithDebug_fcsModel_i_T {
    ...
    real_T DelayInput2_DSTATE;         // '<S163>/Delay Input2'
  ...
  struct DW_SignalConditioningBlock1_g_T {
    ...
    real_T DelayInput2_DSTATE;         // '<S149>/Delay Input2'
  ...
  struct DW_CoreSubsys_fcsModel_p_T {
    ...
    real_T DelayInput2_DSTATE;         // '<S194>/Delay Input2'
  ...
  struct DW_fcsModel_T {
    ...
    real_T last_input_c;               // '<S123>/holdOutputAtCenter'
...
//  Block '<S136>/Delay Input2' : Unused code path elimination
...
//  Block '<S151>/Delay Input2' : Unused code path elimination
...
//  Block '<S195>/Delay Input2' : Unused code path elimination
...
//  Block '<S209>/Delay Input2' : Unused code path elimination
...
//  Block '<S210>/Delay Input2' : Unused code path elimination
...
//  Block '<S224>/Delay Input2' : Unused code path elimination
...
//  Block '<S225>/Delay Input2' : Unused code path elimination
